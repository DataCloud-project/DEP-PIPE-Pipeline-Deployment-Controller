...
public class UserAuthenticationService {
   ...
   UserRegistrationService userRegistrationService;
    ...
    public String loginDatacloudUser(String username, String password) throws Exception {
        String authToken = maestroAuthService.maestroAuthenticateWithCredentials(username, password);
...
//            cookie.setPath("/");
    ...
    public String loginKeycloakAndDatacloudUser(String username, String password) throws Exception {
            KeycloakAuthTokenDto keycloakAuthTokenDto = loginKeycloakUser(username, password);
            String authToken = loginDatacloudUser(username,password);
            return authToken;
    }
